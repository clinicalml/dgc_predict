...
library(rhdf5)
# This differs from the previous version in that I'm using the DNPP predictions
# instead of an ensemble (should actually be a bit more accurate and will also
# avoid having to mention an ensemble in the paper)
